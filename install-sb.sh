...
#gmail
figlet gmail bf
git clone https://github.com/sirwanmd/Gemail-Hack.git >> /dev/null
sleep 2
clear
figlet Installing ...
figlet facebook bf
...
#Instagram 1
#git clone https://github.com/sirwanmd/instainsane.git
cd instainsane
...
# instagram 2
git clone https://github.com/sirwanmd/insta-bf.git
cd insta-bf 
